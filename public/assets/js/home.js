...
const URL = "https://js-ecom-mgjm.onrender.com"
            ...
            <div class="col-sm-4 mt-4">
              <div class="card">
                ...
                <div class="card-body">
                  ...
                  <div>${item.price}</div>
                  <div>${item.desc}</div>
                  <button onclick="handleAddtoCart('${item.id}', '${item.name}', '${item.price}', '${item.image}', '${item.desc}')" type="button" class="btn btn-primary">Add to Cart</button>
                </div>
              </div>
            </div>
